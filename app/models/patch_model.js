...
const patch_model = {
  ...
  async insertClientIntoAppointment(clientId, appointmentId) {
    ...
    try {
      ...
      console.log(
        "client found is " + clientFound.firstname + " " + clientFound.lastname
      );
      ...
      console.log(
        "client id for appointment found is : " + clientIdCOlumnFound?.client_id
      );
      if (!clientIdCOlumnFound) {
        ...
        console.log("number of affected row : " + appointmentUpdated.rowCount);
